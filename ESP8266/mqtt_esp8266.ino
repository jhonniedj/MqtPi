...
const int buttonD3 = 5;     // the number of the pushbutton pin
bool led = false;
...
void setup() {
  ...
  attachInterrupt(digitalPinToInterrupt(4), lamp_on, CHANGE);
  attachInterrupt(digitalPinToInterrupt(5), lamp_off, CHANGE);
}
