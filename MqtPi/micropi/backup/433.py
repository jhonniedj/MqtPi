#!/usr/bin/env python
# _433.py 2015-10-30 Public Domain
""" This module provides two classes to use with wireless 433MHz fobs. The rx class decodes 
received fob codes. The tx class transmits fob codes. """ import time import pigpio class rx():
   """
   ...
   def cancel(self):
      ...
      self.pi.wave_delete(self._amble)
      self.pi.wave_delete(self._wid0)
      self.pi.wave_delete(self._wid1) if __name__ == "__main__":
   import sys
   import time
   import pigpio
   import _433
   ...
   args = len(sys.argv)
   if args > 1:
      # If the script has arguments they are assumed to codes to be transmitted.
